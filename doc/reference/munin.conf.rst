...
.. option:: timeout <seconds>
   ...
   This directive will set how long to wait in seconds before giving up on
   establishing a connection to a munin node when using the munin protocol.
   Default is "180".
...
.. option:: timeout_fetch_all_nodes <seconds>
   ...
   Do not set this value higher, unless all nodes are using ssh with munin-async.
